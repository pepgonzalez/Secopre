...
<head>
	<meta charset="utf-8"/>
	<title><spring:message code="application.title"/> | <spring:message code="application.pages.403"/> </title>
	...
	<link href='<c:url value="/resources/css/plugins/coming-soon.css"/>'  rel="stylesheet" type="text/css"/>
...
<script src='<c:url value="/resources/js/plugins/coming-soon.js"/>' type="text/javascript"></script>
