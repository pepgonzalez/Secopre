								...
								<div class="portlet light ">
									...
									<div class="portlet-body">
										...
										<div class="table-scrollable table-scrollable-borderless">
											...
											<tr>
												<td class="fit">
													<img src="../../assets/admin/layout3/img/avatar5.jpg" class="user-pic">
												</td>
												<td>
											...
											<tr>
												<td class="fit">
													<img src="../../assets/admin/layout3/img/avatar6.jpg" class="user-pic">
												</td>
												<td>
											...
											<tr>
												<td class="fit">
													<img src="../../assets/admin/layout3/img/avatar7.jpg" class="user-pic">
												</td>
												<td>
